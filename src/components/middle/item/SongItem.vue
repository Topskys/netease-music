<template>
  <div class="songItem" @click="toListPage(item.id)" :style="{width:wth+'%'}">
    <el-card :body-style="{ padding: '0px',width:'100%', }" shadow="hover">
      <img :src="item.coverImgUrl || item.sPicUrl || item.cover || item.picUrl" class="image" />
      <slot name="music-t">
        <div class="right-t" style="border-top-right-radius:5px">
